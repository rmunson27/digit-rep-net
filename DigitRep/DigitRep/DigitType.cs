...
public readonly record struct DigitType
{
    ...
    /// <see cref="System.Numerics.BigInteger"/> digits.
    /// </summary>
    public static readonly DigitType BigInteger = new(Values.BigInteger);
    ...
    private static readonly ImmutableDictionary<Type, DigitType> RepresentedTypeDictionary
        = ImmutableDictionary.CreateRange(new KeyValuePair<Type, DigitType>[]
        {
            ...
            new(typeof(BigInteger), BigInteger),
        });
    #endregion
    ...
    /// <see cref="ulong"/> or <see cref="System.Numerics.BigInteger"/>.
    /// </exception>
    ...
    public enum Values : byte
    {
        ...
        /// <summary>
        /// Represents arbitrary precision (non-negative) <see cref="System.Numerics.BigInteger"/> digits.
        /// </summary>
        BigInteger = 255,
    }
    #endregion
